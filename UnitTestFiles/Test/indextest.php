...
<html class="Test-Title" lang="en">
  ...
  <body>
    ...
    <nav class="Check Index" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;">&copy;  Hitachi Vantara Corporation 2017. All Rights Reserved.</p>
        </footer>
